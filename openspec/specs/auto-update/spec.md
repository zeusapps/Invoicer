...
Define how the application knows its own version, discovers newer stable GitHub releases, presents them to the user, and replaces its own executable on confirmation — without ever interrupting or blocking normal use when the check fails.
